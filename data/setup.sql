...
CREATE TABLE input_sources (srcName BLOB UNIQUE, enabled BOOLEAN DEFAULT (0), grpName BLOB, prio INT DEFAULT (10) NOT NULL, catchUp BLOB, addCh BOOLEAN DEFAULT (0), updPeriod INT DEFAULT (8) NOT NULL, updDate BLOB, links INT DEFAULT (0) NOT NULL, srcUrl BLOB, newCh BOOLEAN DEFAULT (0), maxStrm INT DEFAULT (0) NOT NULL, usrAgent BLOB, portalMAC BLOB, portalHLS BOOLEAN DEFAULT (0), repeatStrm BLOB DEFAULT (0), LogoOff BOOLEAN DEFAULT (0), accessIPs BLOB);
